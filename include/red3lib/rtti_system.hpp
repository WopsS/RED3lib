...
struct rtti_system
{
    ...
    hash_map<name_hash, rtti_type*> types;         // 10
    hash_map<name_hash, rtti_function*> functions; // 40
    hash_map<name_hash, void> unk70;               // 70 - Probably hash_map, deduced this based on ASM pattern.
    hash_map<name_hash, void> unkA0;               // A0 - Probably hash_map, deduced this based on ASM pattern.
    int64_t unkD0;                                 // D0
    int32_t unkD8;                                 // D8
    int32_t unkDC;                                 // DC
    int32_t unkE0;                                 // E0
