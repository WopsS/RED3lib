...
{
    detail::RelocFunc<std::uint32_t, name_pool*, const wchar_t*> func(detail::addresses::name_pool::add_wide);
...
{
    detail::RelocFunc<wchar_t*, const CNameHash&> func(detail::addresses::name_pool::find_wide);
    return func(hash);
}

red3lib::name_pool* red3lib::name_pool::instance()
{
    detail::RelocFunc<red3lib::name_pool*> func(detail::addresses::name_pool::get);
    return func();
}
